...
if(empty($oldimage)||$oldimage=='../image/'|| $oldimage==""){
    ...
    if($uperror!==0){
    $sqlnew="UPDATE mytable SET name='$name',email='$email',phone='$phone',address='$address',image='$filelocations' WHERE id='$id'";
                                                     ...
                                                     <tr>
                                                         <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 20px; " align="left">
                                                             <div class="v-text-align" style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                 ...
                                                                 <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="font-family: Cabin, sans-serif; font-size: 14px; line-height: 19.6px;"><span style="font-size: 22px; line-height: 30.8px; color: #000000;">By,'.$name.'</span></span>
                                                                 </p>
...
//Telegram
$x='Account has been updated by '.$name.', Email: '.$email.', Phone Number: '.$phone.', Address: '.$address;
